    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            ...
            \begin{scope}[xshift=7cm]
                ...
                %
                \foreach \coord/\k in {(0,0)/1,(1,0)/2,(2,0)/3,(3,0)/4}
...
In addition to the composition of carrier maps we can also compose carrier maps
with simplicial maps from both sides. To define that properly, we need
