...
\begin{thExample}[consensus]
    ...
    there are more processes than input values.) 
    % TODO: ^  maybe clarify why one might want to assume that
...
tasks \pcref{ch2:barycentricagreement} for all~$N\in\N$ and all occuring
...
assumption of available barycentric agreement protocols is not absurd, to
