...
\begin{figure}[b]
    ...
    \begin{tikzpicture}[scale=1.70]
        ...
        %
    \end{tikzpicture}
    \caption{Example of a finite but not strongly connected $2$-dimensional
             weak pseudomanifold where the highlighted vertex does \emph{not}
             have a euclidean neighborhood}
